...
export const Providers = ({ children }: Props) => {
  return (
    // PayPalScriptProvider es un componente de la libretia '@paypal/react-paypal-js' que aparte de realizar las configuraciones globales, tambien cuando estamos en el punto para comunicarnos con PayPal, automaticamente va a poner la pantalla con la tipica interfaz de PayPal para informarnos, si se esta haciendo una transaccion, etc
